...
<div>
    ...
    <div class="media__btns--container" id="toolbar" v-if="showToolbar" :style="isExpanded ? 'display:block' : 'display:none'">
        <div class="btn-group offset-right">
            <button type="button " class="btn btn-primary green__btn-upload" id="upload" v-if="allowUpload">
        ...
        <div class="btn-group offset-right">
            ...
            <button type="button" v-if="showFolders && allowMove" class="btn btn-default purple__btn-move" data-toggle="modal" :data-target="'#move_files_modal_'+this._uid">
                <i class="voyager-move"></i>
                {{ __('voyager::generic.move') }}
            </button>
            <button type="button" v-if="allowDelete" :disabled="selected_files.length == 0" class="btn btn-default red__btn-delete" data-toggle="modal" :data-target="'#confirm_delete_modal_'+this._uid">
                <i class="voyager-trash"></i>
                {{ __('voyager::generic.delete') }}
            </button>
            <button v-if="allowCrop" :disabled="selected_files.length != 1 || !fileIs(selected_file, 'image')" type="button" class="btn btn-default violet__btn-crop" data-toggle="modal" :data-target="'#crop_modal_'+this._uid">
    ...
    <div id="content" :style="isExpanded ? 'display:block' : 'display:none'">
        ...
        <div class="flex media__folders--cont">
            <div id="left">
                <ul id="files">
