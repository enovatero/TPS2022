    ...
    <div class="page-content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div style="padding-left: 2rem;border-radius: 1rem;" class="panel panel-bordered">
                    <!-- form start -->
                        ...
                        <div class="panel-body">
                            ...
                            @foreach($dataType->addRows as $row)
                                <div class="form-group">
                                    ...
                                    <span class="input__lowerWidth"> {!! Voyager::formField($row, $dataType, $dataTypeContent) !!} </span>
