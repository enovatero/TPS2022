...
@section('page_header')
    <h1 style="display: flex !important; margin-bottom: 6rem !important;" class="page-title">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="no-sort no-click bread-actions">
                                        @can('delete', $data)
                                            <div class="btn btn-sm btn-danger pull-right delete red__btn-delete" data-id="{{ $data->{$data->getKeyName()} }}">
