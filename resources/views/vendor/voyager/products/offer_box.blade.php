          ...
          <tr parent_id="{{$parent->id}}">
            ...
            <td style="text-align:center">
              <input type="number"
                ...
                autocomplete="off" class="form-control input-sm changeQty parentId-{{$parent->id}}" parentId="{{$parent->id}}" style="width: 70px; display:inline; color: black; font-size: 14px"
              />
            </td>
            <td style="text-align:center;">
