...
@section('javascript')
    ...
    <script>
        $(document).ready(function () {
          ...
          $(".btnForceWinMentor").click(function(){
            if(confirm("Sunteti sigur ca doriti preluarea produselor din WinMentor?")){
                $("#voyager-loader").show();
                var html_insert = `<h5 style='position: absolute;top: 62%;left: 0;width: 100%;margin: 0 auto;right: 0;bottom: 0;text-align: center;'>Se preiau produsele... Va rugam asteptati</h5>`
                $(html_insert).insertAfter($("#voyager-loader>img"));
                var vthis = this;
                $.ajax({
                    method: 'GET',
                    url: '/admin/forceFetchProductsWinMentor',
                    context: this,
                    async: true,
                    cache: false,
                    dataType: 'json'
