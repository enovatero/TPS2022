        ...
        @foreach($parents as $key =>  $parent)
          ...
          <tr>
            ...
            <td style="text-align:center">
              <input type="number" readonly autocomplete="off" class="form-control input-sm changeQty parentId-{{$parent->id}}" parentId="{{$parent->id}}" style="width: 70px; display:inline" name="offerQty[]">
            </td>
            <td style="text-align:center;">
