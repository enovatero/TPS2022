                                    ...
                                    @else
                                      ...
                                      @endphp
                                        ...
                                        @if($row->field == 'exchange')
                                          <button type="button" class="btn btn-success ml-5 btnCursBnr">Ia curs EUR BNR</button>
                                        @endif
                  ...
                  <div class="half">
                      <ul class="feature" id='right-lovehandles'>
                          <li class="feature-item">
                              <div class="feature-inner">
                                  <div class="feature-text">
                                      <p><span class='handle icon voyager-move' style="transform: rotateZ(180deg)"></span></p>
                                      <p>{{$products[0]->name}} - test</p>
                                  </div>
                              </div>
                          </li>
                      </ul>
...
//             }
      ...
      new Dragster(options, document.getElementById('left-lovehandles'), document.getElementById('right-lovehandles'));
