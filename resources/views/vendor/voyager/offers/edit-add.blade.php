...
@section('page_header')
    <h1 class="page-title">
        ...
        @endif
        @if($edit) - <span style="background: {{$dataTypeContent->status_name->bg_color}}; color: {{$dataTypeContent->status_name->text_color}}; font-size: 18px; padding: 5px">{{strtoupper($dataTypeContent->status_name->title)}}</span> @endif
...
@section('content')
    <div
        class="page-content edit-add container-fluid {{$edit && $dataTypeContent->numar_comanda != null ? 'comanda-productie' : ''}}">
        <div class="row">
            @if($edit)
                <div class="col-md-12">
                    <ul class="nav nav-tabs" style="width: max-content;">
                        ...
                        <li class="">
                            <a data-toggle="tab" href="#awb" aria-expanded="false" class="btnOfertaAwb">Detalii livrare
                                / AWB</a>
                        </li>
                    </ul>
                </div>
                @if($edit)
                    <div class="col-md-12 butoane-oferta" test="{{$dataTypeContent->status_name->title}}">
                        ...
                        @if($dataTypeContent->delivery_type == 'nemo' && $dataTypeContent->nemoData && $dataTypeContent->nemoData->cont_id != null && $dataTypeContent->nemoData->awb != null)
                            <a target="_blank" class="btn btn-success btn-add-new btnDownloadAwbNemo"
                               href="/admin/printAwbNemo/{{$dataTypeContent->nemoData->awb}}/{{$dataTypeContent->nemoData->cont_id}}/{{$dataTypeContent->nemoData->hash}}"
                               style="border-left: 6px solid #57c7d4; color: #57c7d4;margin-left: 15px;">
                                <i class="voyager-eye" style="margin-right: 10px;"></i> <span> Descarca AWB PDF</span>
                            </a>
                        @endif
                        @if($dataTypeContent->numar_comanda == null)
                            <a class="btn btn-success btn-add-new btnAcceptOffer"
                               style="border-left: 6px solid #57c7d4; color: #57c7d4;margin-left: 15px;"
                        ...
                        @if($dataTypeContent->numar_comanda != null)
                            ...
                            @if($dataTypeContent->status_name->title == 'noua' || $dataTypeContent->status_name->title == 'anulata' || $dataTypeContent->status_name->title == 'modificata' || $dataTypeContent->status_name->title == 'productie')
                                <a class="btn btn-success btn-add-new btnSchimbaStatus" status="expediata"
                                   order_id="{{$dataTypeContent->getKey()}}"
                                   style="border-left: 6px solid #57c7d4; color: #57c7d4;margin-left: 15px;">
                                    <i class="voyager-bolt" style="margin-right: 10px;"></i>
                                    <span>Comanda expediata</span>
                                </a>
                            @endif
                            @if($dataTypeContent->status_name->title == 'expediata')
                                <a class="btn btn-success btn-add-new btnSchimbaStatus" status="livrata"
                                   order_id="{{$dataTypeContent->getKey()}}"
                                   style="border-left: 6px solid #57c7d4; color: #57c7d4;margin-left: 15px;">
                                    <i class="voyager-truck" style="margin-right: 10px;"></i>
                                    <span>Comanda livrata</span>
                                </a>
                            @endif
                            @if($dataTypeContent->status_name->title == 'livrata' || $dataTypeContent->status_name->title == 'expediata')
                                <a class="btn btn-success btn-add-new btnSchimbaStatus" status="retur"
                                   order_id="{{$dataTypeContent->getKey()}}"
                                   style="border-left: 6px solid #57c7d4; color: #57c7d4;margin-left: 15px;">
                                    <i class="voyager-warning" style="margin-right: 10px;"></i>
                                    <span>Comanda retur</span>
                                </a>
                            @endif
                        @endif
                    </div>
                            ...
                            <div style="width: 100%;">
                                @if($edit)
                                    ...
                                    <!-- Adding / Editing -->
                                        ...
                                        <div class="flex__box--cont">
                                            ...
                                            @if($edit)
                                                ...
                                                <div class="form-group col-md-12 mesaj-intern-container flex__box1">
                                                    ...
                                                    <textarea class="form-control" id="mentions"
                                                              name="mentions_textarea" placeholder="Mesaj nou"
                                                              rows="5"></textarea>
                                                    <button style="float: right;" type="button"
                                                            class="btn btn-primary save btnSaveMention"
                                                            order_id="{{$dataTypeContent->id}}">Salveaza mesaj
                                                    </button>
                                        ...
                                        @if($edit)
                                            <div class="flex__box--cont">
                                                ...
                                                @if($edit)
                                                    ...
                                                    <div
                                                        class="form-group col-md-12 mesaj-intern-container log-evenimente flex__box1 height__1">
                                        ...
                                        @else
                                            <div class="panel-body container-doua-col-left"
                                                 style="background: #f9f9f9;width: 100%;display: flex;flex-direction: column;">
                                                ...
                                                <div @if($edit) style="width: 70%;margin: 0;"
                                                     @else style="width: 100%;margin: 0;"
                                                     @endif class="flex__box--cont">
                                                    ...
                                                    @if($edit)
                                                        ...
                                                        <div
                                                            class="form-group col-md-12 mesaj-intern-container flex__box1">
                                                            <label class="control-label">Mesaje comanda</label>
                                                            <input name="mentions" type="hidden"/>
                                                            <textarea class="form-control" id="mentions"
                                                                      name="mentions_textarea" placeholder="Mesaj nou"
                                                                        ...
                                                                        @foreach($filteredColors as $key => $item)
                                                                            <div class="form-group">
                                                                                <label class="control-label"
                                                                                       for="name">{{ucfirst($key)}}</label>
                                                                                <select name="selectedAttribute[]"
                                                                                        class="form-control selectColor selectAttribute">
                                                                                    <option selected disabled>
                                                                                        Selecteaza {{strtolower($key)}}</option>
                                                                                    @foreach($item as $color)
                                                                                        @php
                                                            ...
                                                            @else
                                                                ...
                                                                @else
                                                                    ...
                                                                    @if(isset($display_options->id) && $display_options->id == 'mod_livrare' && $edit)
                                                                        <div class="form-group  col-md-12">
                                                                            <label class="control-label">Adresa
                                                                                livrare</label>
                                                                            <select name="delivery_address_user"
                                                                                    class="form-control">
                                                                                ...
                                                                                <option value="-2">Adauga adresa noua
                                                                                </option>
                                                                                @if(count($userAddresses) > 0)
                                                                                    @foreach($userAddresses as $address)
                                                                                        @if(($selectedAddress != null && $selectedAddress->id == $address->id) || ($dataTypeContent->delivery_address_user == $address->id))
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            style="width: 100%; display: none;">
                                                                            <div
                                                                                class="panel-body container-box-adresa">
                                                                                <input class="trick-addr-id" value=""
                                                                                       type="hidden"/>
                                                                                <div
                                                                                    class="form-group col-md-12 column-element-address"
                                                                                    style="width: 100%">
                                                                                    <label
                                                                                        class="control-label">Tara</label>
                                                                                    @include('vendor.voyager.formfields.countries', ['selected' => null])
                                                                                </div>
                                                                                <div
                                                                                    class="form-group col-md-12 column-element-address">
                                                                                    <label class="control-label"
                                                                                           for="state">Judet/Regiune</label>
                                                                                    <select name="state"
                                                                                            class="form-control select-state"></select>
                                                                                </div>
                                                                                <div
                                                                                ...
                                                                                <div
                                                                                    class="form-group col-md-12 column-element-address">
                                                                                    <label class="control-label">Persoana
                                                                                        de contact</label>
                                                                                    <input name="delivery_contact"
                                                                                           type="text"
                                                                                           style="padding: 5px;"/>
                                                                                </div>
                                                                            </div>
                                            ...
                                            <div class="panel-body container-doua-col-right"
                                                 @if (count($errors) > 0 && array_key_exists('address', $errors->toArray())) style="display: block !important;" @endif>
                                                {{csrf_field()}}
                                                @if($edit)
                                                    <input name="offer_id" type="hidden"/>
                                                @endif
                                                <div class="form-group  col-md-12 ">
                                                    <h4 class="control-label font-weight-bold" for="name">Adaugare
                                                        client</h4>
                                                </div>
                                                <div class="form-group  col-md-12 tip-client-container">
                                                    ...
                                                    <ul class="radio">
                                                        <li>
                                                            <input type="radio" id="option-type-fizica"
                                                                   name="persoana_type" value="fizica"
                                                                   @if(old('persoana_type', $dataTypeContent->persoana_type) == 'fizica' || old('persoana_type', $dataTypeContent->persoana_type) == '') checked="" @endif>
                                                            <label for="option-type-fizica">Persoana fizica</label>
                                                            <div class="check"></div>
                                                        </li>
                                                        <li>
                                                            <input type="radio" id="option-type-juridica"
                                                                   name="persoana_type" value="juridica"
                                                                   @if(old('persoana_type', $dataTypeContent->persoana_type) == 'juridica') checked="" @endif>
                                                ...
                                                <div>
                                                    <div class="form-group col-md-12 column-element-address">
                                                        <label class="control-label">Introdu adresa(strada, nr, bloc,
                                                            etaj, ap)</label>
                                                        <input class="form-control" type="text" name="address[]"
                                                               value="{{ old('address', $dataTypeContent->address ?? '') != '' ? old('address', $dataTypeContent->address)[0] : ''}}"/>
                                                    </div>
                                                    <div class="form-group col-md-12 column-element-address">
                                                        <label class="control-label">Denumire WME</label>
                                                        <input class="form-control" type="text" name="wme_name[]"
                                                               value="{{ old('wme_name', $dataTypeContent->wme_name ?? '') != '' ? old('wme_name', $dataTypeContent->wme_name)[0] : ''}}"/>
                                                    </div>
                                                    <div class="form-group col-md-12 column-element-address">
                                                        <label class="control-label">Tara</label>
                                                        @include('vendor.voyager.formfields.countries', ['selected' => null])
                                    ...
                                    @if($edit)
                                        ...
                                        <div class="col-md-12 butoane-oferta"
                                             test="{{$dataTypeContent->status_name->title}}">
                                            <a target="_blank" class="btn btn-success btn-add-new"
                                               href="/admin/generatePDF/{{$dataTypeContent->id}}"
                                               style="border-left: 6px solid #57c7d4; color: #57c7d4;margin-left: 15px;">
                                            ...
                                            @if($dataTypeContent->delivery_type == 'nemo' && $dataTypeContent->nemoData && $dataTypeContent->nemoData->cont_id != null && $dataTypeContent->nemoData->awb != null)
                                                <a target="_blank"
                                                   class="btn btn-success btn-add-new btnDownloadAwbNemo"
                                                   href="/admin/printAwbNemo/{{$dataTypeContent->nemoData->awb}}/{{$dataTypeContent->nemoData->cont_id}}/{{$dataTypeContent->nemoData->hash}}"
                                                   style="border-left: 6px solid #57c7d4; color: #57c7d4;margin-left: 15px;">
                                                    <i class="voyager-eye" style="margin-right: 10px;"></i> <span> Descarca AWB PDF</span>
                                                </a>
                                            ...
                                            @if($dataTypeContent->numar_comanda != null)
                                                ...
                                                @if($dataTypeContent->status_name->title == 'noua' || $dataTypeContent->status_name->title == 'anulata' || $dataTypeContent->status_name->title == 'modificata' || $dataTypeContent->status_name->title == 'productie')
                                                    <a class="btn btn-success btn-add-new btnSchimbaStatus"
                                                       status="expediata" order_id="{{$dataTypeContent->getKey()}}"
                                                       style="border-left: 6px solid #57c7d4; color: #57c7d4;margin-left: 15px;">
                                                ...
                                                @if($dataTypeContent->status_name->title == 'expediata')
                                                    <a class="btn btn-success btn-add-new btnSchimbaStatus"
                                                       status="livrata" order_id="{{$dataTypeContent->getKey()}}"
                                                       style="border-left: 6px solid #57c7d4; color: #57c7d4;margin-left: 15px;">
                                                ...
                                                @if($dataTypeContent->status_name->title == 'livrata' || $dataTypeContent->status_name->title == 'expediata')
                                                    <a class="btn btn-success btn-add-new btnSchimbaStatus"
                                                       status="retur" order_id="{{$dataTypeContent->getKey()}}"
                                                       style="border-left: 6px solid #57c7d4; color: #57c7d4;margin-left: 15px;">
                                                        <i class="voyager-warning" style="margin-right: 10px;"></i>
                                                        <span>Comanda retur</span>
                                                    </a>
    ...
    @if($edit)
        <div class="modal fade modal-danger" id="create_new_client" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="display: flex;">
                        <button type="button" class="btn btn-default"
                                data-dismiss="modal">{{ __('voyager::generic.cancel') }}</button>
                        <button type="button" class="btn btn-danger" id="confirm_create_client" style="height: 3.2rem;">
                            Adauga client
                        </button>
                    </div>
                </div>
            ...
            function getPreselectedColorsAndUpdate(selectedColor) {
                $.ajax({
                    ...
                    data: {
                        ...
                        offerId: '{{$dataTypeContent->id}}',
                        offerType: '{{$dataTypeContent->type}}'
                    },
                    context: this,
                    async: true,
                    cache: false,
