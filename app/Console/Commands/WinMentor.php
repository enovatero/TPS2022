...
class WinMentor extends Command
{
    ...
    public function handle()
    {
        ...
        $url = "http://" . config('winmentor.host') . ":" . config(
                'winmentor.port'
            ) . "/datasnap/rest/TServerMethods/%22GetInfoArticole%22/";
        //  Initiate curl
        $ch = curl_init();
...
//                $checkProduct->mentor_cod_obiect = $product['CodExtern'];
//                $checkProduct->mentor_description = null;
//                $checkProduct->mentor_cod_intern = $product['CodIntern'];
//                $checkProduct->mentor_cod_extern = $product['CodExtern'];
...
//                $counterUpdate++;
                ...
                array_push(
                    ...
                    [
                        ...
                        'mentor_cod_extern' => $product['CodExtern'],
        ...
        return [
            'success' => true,
            'msg' => "Au fost adaugate " . $counterInsert . " produse si modificare " . $counterUpdate . " produse."
        ];
    }
}
